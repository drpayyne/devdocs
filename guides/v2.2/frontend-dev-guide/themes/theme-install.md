...
To make sure the theme is registered, in the _Admin_ panel navigate to **Content** > Design > **Themes**. If a theme is registered, it is displayed in the list of available themes.
